...
const features = [
  {
    ...
    title: "Detekcija manipulacija",
    desc: "ELA analiza, FFT spektar, CNN duboka detekcija i Mesorch (AAAI 2025) otkrivaju Photoshop manipulacije i copy-paste krivotvorine.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "AI detekcija (10 modula)",
    desc: "SAFE, DINOv2, CLIP, EfficientNet, CommFor, B-Free, SPAI i drugi nezavisni detektori prepoznaju AI-generirane slike i deepfakeove.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Rule-based decision engine analizira sve forenzičke module, pragove rizika i metapodatke — donosi odluku s punim traceom.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Analiza PDF strukture, provjera digitalnih potpisa, detekcija manipulacija fontova, AI tekst detekcija i OIB/IBAN validacija.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Kriptografski dokazi",
    desc: "SHA-256 hash, C2PA potpis, RFC 3161 vremenski pečat i lanac skrbništva (ISO 27037) za sudsku admisibilnost.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Metapodaci i senzori",
    desc: "EXIF analiza, PRNU senzorski otisak, spektralna i optička forenzika otkrivaju nekonzistentnosti u metapodacima.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    desc: "22 forenzička modula provjeravaju autentičnost, detektiraju manipulacije i AI-generirani sadržaj, decision engine donosi odluku.",
  },
  {
    num: "03",
