...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-[20%] -right-32 w-[550px] h-[550px] rounded-full deco-circle" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
          <div className="text-center mb-12">
            <p className="text-xs font-semibold uppercase tracking-widest text-accent mb-2">
      ...
      <section className="relative overflow-hidden section-alt border-y border-border">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute -top-16 -left-24 w-[450px] h-[450px] rounded-full deco-circle" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
          <div className="text-center mb-12">
            <p className="text-xs font-semibold uppercase tracking-widest text-accent mb-2">
      ...
      <section className={`relative overflow-hidden ${loaded && stats && stats.totalInspections > 0 ? "section-alt border-y border-border" : "border-t border-border section-alt"}`}>
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute -top-24 right-[25%] w-[500px] h-[500px] rounded-full deco-circle" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
