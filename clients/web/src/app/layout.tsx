      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var d=document.documentElement;var t=localStorage.getItem("dent_theme");if(t==="dark")d.classList.add("dark");if(document.cookie.indexOf("dent_has_auth=1")!==-1)d.dataset.auth="1";var m=document.querySelector('meta[name="theme-color"]');if(t==="dark"&&m)m.content="#0f172a"}catch(e){}})()`,
          }}
        />
      </head>
      <body
