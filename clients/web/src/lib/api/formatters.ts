...
export function forensicModuleLabel(moduleName: string): string {
  const labels: Record<string, string> = {
    ...
    bfree_detection: "B-Free AI detekcija (CVPR 2025)", spai_detection: "SPAI spektralna AI detekcija (CVPR 2025)", siglip_ai_detection: "SigLIP AI detekcija", rine_detection: "RINE AI detekcija (ECCV 2024)", organika_ai_detection: "Organika AI detekcija (Swin)", pixel_forensics: "Pixel forenzika (8 signala)",
